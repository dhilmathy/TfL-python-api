...
print (client.get_line_meta_modes()[0])
...
#print(client.get_stop_points_by_line_id("victoria")[0])
#print(client.get_route_by_mode("bus")[0])
#print(client.get_line_disruptions_by_line_id("victoria")[0])
...
#print (client.get_arrivals_by_line_id("victoria")[0])